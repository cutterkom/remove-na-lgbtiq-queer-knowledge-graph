...
only_in_wd <- reactive({
  ...
  distinct(fg_item, fg_itemLabel, wd_item, fg_property_id, wd_property_id, wd_value_from_wd, wd_value_from_wdLabel, fg_value_from_wd) %>% 
  # remove those that are present in wd
  anti_join(in_both(), by = c("fg_item", "wd_value_from_wd")) %>%
  # add property info
  left_join(input_properties() %>% select(fg_property_id, fg_propertyLabel, fg_property, wd_property, wd_property_id), by = c("fg_property_id", "wd_property_id"))
