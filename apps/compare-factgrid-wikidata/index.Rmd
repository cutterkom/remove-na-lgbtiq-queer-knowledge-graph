...
observeEvent(input$button_start_property_parts_of, {
  ...
  insertUI(
      ...
      where = "afterEnd",
      ui = checkboxGroupInput("input_properties", label = "Available properties:", choices = get_properties_list(all_properties, input$property_parts_of))
    )
})
```
