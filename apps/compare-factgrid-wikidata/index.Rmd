...
#shinyFeedback::loadingButton("button_start_person_properties", label = "Submit")
```
...
comparison_raw <- eventReactive(input$button_start_person_properties, {
  ...
  if(is.null(input$person_properties)) {
    ...
    #shinyFeedback::resetLoadingButton("button_start_person_properties")
    shinyFeedback::showToast(
      "success", 
      "data loaded"
    )
...
observeEvent(input$button_import_to_wikidata, {
  ...
  # tableInput("name", "What's your name?",import_in_wikidata()),
  
#))
  # # shinyalert(title = "Hey", text = import_in_wikidata())
  ...
  #     ))
    ...
    shinyFeedback::showToast(
      ...
      message = 'go to Factgrid Quickstatements to import it.',
      .options = list("hideDuration" = FALSE)
    )
})
```
