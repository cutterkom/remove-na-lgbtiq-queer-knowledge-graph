...
save_decision <- function(candidates, decision, ...) {
  ...
  if (decision == "positive") {
    if (input$keep_candidate_2_label == TRUE) {
      query <- paste0("UPDATE ", db_tbl_candidates, " SET decision = '", this_decision, "', keep_label_2 = 1 WHERE id =", candidates$id, ";")
    } else {
      query <- paste0("UPDATE ", db_tbl_candidates, " SET decision = '", this_decision, "' WHERE id =", this_candidate_id, ";")
    }
