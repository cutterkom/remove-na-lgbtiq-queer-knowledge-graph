...
save_decision <- function(candidates, decision, ...) {
  ...
  if (decision == "positive") {
    ...
    if(input$keep_candidate_2_label == TRUE) {
      query <- paste0("UPDATE matching_candidates_authors_books_posters SET decision = 'positive', keep_label_2 = 1 WHERE id =", candidates$id, ";")
    } else {
...
observeEvent(input$button_positive, {
    print(input$keep_candidate_2_label)
